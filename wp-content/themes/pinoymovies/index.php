...
<?php get_header(); ?>
		...
		<div class="movie-menu">
			<ul>
				<li id="pinoymovies" class="menu"><a href="javascript:void(0);"><h1>Pinoy Movies</h1></a><span><a href="<?php bloginfo('url'); ?>/category/pinoy-movies/feed/rss">RSS</a></span></li>
				<li id="tvprograms" class="menu disabled"><a href="javascript:void(0);"><h1>Most Popular</h1></a></li>
				<li id="asianhorror" class="menu disabled"><a href="javascript:void(0);"><h1>Popular Searches</h1></a></li>
